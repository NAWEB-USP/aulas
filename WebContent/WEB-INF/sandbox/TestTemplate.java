...
public class RealizaTesteNaClasseSubmetida {
	...
	public static void assertEquals(int valor, int expected, String txt) throws Exception {
		if (expected != valor) {
			throw new TestException("Falha na execu&ccedil;&atilde;o.\n Para "+txt+" era esperado "+expected +", por&eacute;m retornou "+valor+".");
		}
	}
	...
	public static void assertEquals(Object valor, Object expected, String txt) throws Exception {
		if (expected == null) {
			if (valor != null) {
				throw new TestException("Falha na execu&ccedil;&atilde;o.\n Para "+txt+" era esperado null, por&eacute;m retornou \""+valor.toString()+"\".");
			}
		} else {
			if (!expected.equals(valor)) {
				throw new TestException("Falha na execu&ccedil;&atilde;o.\n Para "+txt+" era esperado \""+expected.toString() +"\", por&eacute;m retornou \""+valor.toString()+"\".");
			}
		}
	}
	...
	public static void assertBetween(int valor, int liminf, int limsup, String txt) throws Exception {
		if (valor < liminf || valor > limsup) {
			throw new TestException("Falha na execu&ccedil;&atilde;o.\n Para "+txt+" era esperado um valor entre "+liminf
               +" e "+limsup +", por&eacute;m retornou "+valor+".");
		}
	}
	
	public static void assertTrue (boolean valor, String txt) throws Exception {
		if (!valor) {
			throw new TestException("Falha na execu&ccedil;&atilde;o.\n Para "+txt+" era esperado true, por&eacute;m retornou false.");
		}
	}
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("Executou corretamente. Parab&eacute;ns!"); // Este texto é usado para detectar respostas corretas.
			System.err.println("Executou corretamente. Parab&eacute;ns!"); // Este texto é usado para detectar respostas corretas.
			System.exit(0);
